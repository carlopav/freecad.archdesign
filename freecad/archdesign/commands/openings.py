...
import freecad.archdesign.functions.make_opening as make_opening
import freecad.archdesign.functions.make_opening_template as make_opening_template
import freecad.archdesign.functions.make_opening_type as make_opening_type
...
class MakeOpeningBase(GuiCommandBase):
...
class MakeOpeningElement(MakeOpeningBase):
    """The Arch Opening command definition"""

    def GetResources(self):
        return {'Pixmap'  : os.path.join(ICONPATH,"ArchDesign_Opening.svg"),
    ...
    def Activated(self):
        ...
        super(MakeOpeningElement, self).Activated()

    def finish(self):
        super(MakeOpeningElement, self).finish()
...
class MakeWindow(MakeOpeningBase):
    ...
    def Activated(self):
        ...
        super(MakeWindow, self).Activated()

    def finish(self):
        super(MakeWindow, self).finish()
        App.ActiveDocument.openTransaction("Create Window")
...
class MakeDoor(MakeOpeningBase):
    ...
    def Activated(self):
        ...
        super(MakeDoor, self).Activated()

    def finish(self):
        super(MakeDoor, self).finish()
        App.ActiveDocument.openTransaction("Create Window")
...
class MakeWindowTemplate(GuiCommandBase):
...
class MakeDoorTemplate(GuiCommandBase):
...
class MakeOpeningType(GuiCommandBase):
...
class MakeWindowType(MakeOpeningType):
    """The Arch_Window_Type command definition.
    """
...
class MakeDoorType(MakeOpeningType):
