...
from freecad.archdesign.functions.joinwalls import join_walls
...
class JoinWalls:
    ...
    def GetResources(self):
        ...
        return {'Pixmap'  : os.path.join(ICONPATH,"ArchDesign_JoinWall.svg"),
...
class ExtendWall(JoinWalls):
    """ Arch_ExtendWall command definition.
    """

    def GetResources(self):

        return {'Pixmap'  : os.path.join(ICONPATH,"ArchDesign_ExtendWall.svg"),
